...
\begin{document}
	...
	Informalmente podemos decir que un algoritmo es una receta para resolver un problema especifico. Como receta en fin tiene que constar con una serie de pasos claros y ordenados que si se siguen correctamente te deben llevar de un estado inicial a un estado final, que es no debe variar independientemente de quien lo ejecute.
	...
	\begin{ejemplo}
		Un algoritmo con 0 entradas es el que te devuelve la suma de los números del 1 al 100
	\end{ejemplo}
	\begin{observacion}
	...
	\begin{ejemplo}
		Un algoritmo para determinar si un numero es primo.
...
Función que nos permitirá medir el tiempo de los algoritmos:
...
Para el problema \textbf{3}, el algoritmo propuesto consiste en sumar $n$ veces la suma de los números del $1$ hasta $n$. A continuación, se muestran algunos tiempos de ejecución:
...
\textbf{Estructura total del ciclo interno}
...
Costo estructural interno total:
...
\begin{ejercicio}
	Describe qué hace el algoritmo propuesto en el código para el Problema 4.
\end{ejercicio}

Como se puede observar, el cálculo del número de operaciones y de las constantes asociadas $c_i$ puede llegar a ser bastante tedioso.
...
En la siguiente clase estudiaremos el método más utilizado para el análisis de eficiencia.
